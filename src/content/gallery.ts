...
export const GALLERY: GallerySection[] = [
  {
    ...
    photos: [
      ...
      { file: 'img-8701', alt: 'An osprey gliding across a blue sky', px: '' },
      { file: 'img-8635', alt: 'An osprey high in a clear blue sky', px: '' },
      ...
      { file: 'img-8596', alt: 'A squirrel on a tree trunk', px: '' },
    ],
  },
  {
    title: 'Cities & Landmarks',
    photos: [
      { file: 'img-2801-enhanced-nr', alt: 'Tower Bridge lit up at night, taken from The Shard', px: '', loc: 'London' },
      ...
      { file: 'img-3466-hdr', alt: 'The Eiffel Tower from below', px: '', loc: 'Paris' },
      { file: 'img-3460-hdr-edit', alt: 'The Eiffel Tower', px: '', loc: 'Paris' },
      ...
      { file: 'img-4012', alt: 'The London Eye across the river', px: '', loc: 'London' },
    ],
  },
  {
    title: 'Landscapes',
