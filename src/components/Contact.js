    ...
    render() {
        return (
            <div className="App-contact">
                <a className="fivehundredpx icon" href="http://500px.com/cbisesar" target="_blank" />
                <a className="facebook icon" href="https://www.facebook.com/Gr1mdrag0n" target="_blank" />
                <a className="linkedin icon" href="http://lnkd.in/tVbZ6W" target="_blank" />
                <a className="mail icon" href="mailto:c.bisesar@gmail.com" target="_blank" />
            </div>
        );
    }
}
